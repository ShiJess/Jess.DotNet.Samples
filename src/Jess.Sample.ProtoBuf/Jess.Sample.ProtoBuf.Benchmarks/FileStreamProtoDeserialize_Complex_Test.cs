...
namespace Jess.Sample.ProtoBuf.Benchmarks
{
    ...
    public class FileStreamProtoDeserialize_Complex_Test
    {
        ...
        public void te1()
        {
            ProtoBufHandler.UseFileStreamDeserialize_Complex();
        }
        ...
        public void b2()
        {
            ProtoBufNetHandler.UseFileStreamDeserialize_Complex();
        }
